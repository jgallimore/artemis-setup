...
public class ReceiverBean implements MessageListener {
    ...
    private final Logger logger = Logger.getLogger(ReceiverBean.class.getName());
    ...
    public void onMessage(Message message) {
        ...
        try {
            if (TextMessage.class.isInstance(message)) {
                ...
                logger.info("Hello from Apache Active MQ Artemis! Message received: " + textMessage.getText());
            }
